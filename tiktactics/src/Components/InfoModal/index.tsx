...
export default function InfoModal({ message, clearMessage, button, buttonAction }: InfoModalProps) {
    ...
    return (
        <div className={styles.overlay}>
            <div className={styles.modal}>
                ...
                {button && <button className={styles.button} onClick={handleButtonClick}>{button}</button>}
            </div>
        </div>
    )
}
